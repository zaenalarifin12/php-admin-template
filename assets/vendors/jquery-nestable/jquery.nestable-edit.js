...
;(function($, window, document, undefined)
{
    ...
    Plugin2.prototype = {
        init: function()
        {
            ...
            $.each(this.el.find(list.options.itemNodeName), function(k, el) {
				...
				/* Changes: Add Close Button */
				$removeBtn = $(list.options.removeBtnHTML).addClass('dd-remove');
				$editBtn = $(list.options.editBtnHTML);
				$(el).prepend($editBtn);
            ...
            list.el.on('click', 'button', function(e) {
				...
				/* Changes: Add Remove Event */
				if (action === 'remove') {
					result = list.options.beforeClose(item, list);
					if (result) {
						
						list.deleteList(item, list);
					}
				...
				/* Changes: Add Remove Event */
				if (action === 'edit') {
					list.options.editBtnCallback(this);
                }
            });
        ...
        setParent: function(li)
        {
            if (li.children(this.options.listNodeName).length) {
                li.prepend($(this.options.expandBtnHTML).addClass('dd-expand-btn'));
                li.prepend($(this.options.collapseBtnHTML).addClass('dd-collapse-btn'));
            }
            li.children('[data-action="expand"]').hide();
        },
		
		/* Changes: Preserve Close Button */
    ...
    $.fn.nestable2 = function(params)
    {
        ...
        lists.each(function()
        {
            ...
            if (!plugin) {
                $(this).data("nestable", new Plugin2(this, params));
