		...
		<form method="post" action="" class="form-horizontal" enctype="multipart/form-data">
			<div class="tab-content" id="myTabContent">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input class="form-control date-picker" type="text" name="tgl_lahir" value="<?=set_value('tgl_lahir', @$tgl_lahir)?>" placeholder="Tgl. Lahir"/>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<?php 
						if (!empty($foto))
						echo '<div class="list-foto" style="margin:inherit"><img src="'.BASE_URL.'/assets/images/foto/' . $foto . '"/></div>';
						...
						<div id="upload-img-thumb"><span class="img-prop"></span></div>
					</div>
				</div>
